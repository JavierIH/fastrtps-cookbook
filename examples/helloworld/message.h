...
public:
     ...
     */
    inline eProsima_user_DllExport void text(const std::string &_text)
    {
        m_text = _text;
    }
     ...
     */
    inline eProsima_user_DllExport void text(std::string &&_text)
    {
     ...
     */
    inline eProsima_user_DllExport const std::string& text() const
    {
        return m_text;
    }
     ...
     */
    inline eProsima_user_DllExport std::string& text()
    {
        return m_text;
    }
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const Message& data, size_t current_alignment = 0);
